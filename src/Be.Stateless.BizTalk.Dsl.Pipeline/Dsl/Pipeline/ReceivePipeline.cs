...
namespace Be.Stateless.BizTalk.Dsl.Pipeline
{
	...
	public abstract class ReceivePipeline : Pipeline<IReceivePipelineStageList>
	{
		...
		public IComponentList Decoders => Stages.Decode.Components;
		...
		/// </summary>
		[SuppressMessage("ReSharper", "MemberCanBeProtected.Global", Justification = "Public DSL API.")]
		public IComponentList Disassemblers => Stages.Disassemble.Components;
		...
		/// </summary>
		public IComponentList Validators => Stages.Validate.Components;
		...
		/// </summary>
		public IComponentList PartyResolvers => Stages.ResolveParty.Components;
