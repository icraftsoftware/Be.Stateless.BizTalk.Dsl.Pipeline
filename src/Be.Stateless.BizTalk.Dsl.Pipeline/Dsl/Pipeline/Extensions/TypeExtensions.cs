...
namespace Be.Stateless.BizTalk.Dsl.Pipeline.Extensions
{
	...
	{
		public static ReceivePipeline AsReceivePipeline(this Type type)
		{
		...
		public static SendPipeline AsSendPipeline(this Type type)
		{
			if (type == null) throw new ArgumentNullException(nameof(type));
		...
		public static bool IsPipelineDefinition(this Type type)
		{
			return type.IsReceivePipelineDefinition() || type.IsSendPipelineDefinition();
		}

		[SuppressMessage("ReSharper", "MemberCanBePrivate.Global", Justification = "Public API.")]
		public static bool IsReceivePipelineDefinition(this Type type)
		{
			return type.IsConcrete() && _dslBaseReceivePipelineType.IsAssignableFrom(type.GetTypeInfo());
		}

		[SuppressMessage("ReSharper", "MemberCanBePrivate.Global", Justification = "Public API.")]
		public static bool IsSendPipelineDefinition(this Type type)
		{
