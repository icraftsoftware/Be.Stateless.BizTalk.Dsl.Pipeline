...
namespace Be.Stateless.BizTalk.Dsl.Pipeline
{
	...
	public abstract class SendPipeline : Pipeline<ISendPipelineStageList>
	{
		...
		public IComponentList PreAssemblers => Stages.PreAssemble.Components;
		...
		/// </summary>
		[SuppressMessage("ReSharper", "MemberCanBeProtected.Global", Justification = "Public DSL API.")]
		public IComponentList Assemblers => Stages.Assemble.Components;
		...
		/// </summary>
		public IComponentList Encoders => Stages.Encode.Components;
